...
public static partial class HostAdminProtocol
{
    ...
    public static JsonObject Features(JsonNode? health)
    {
        ...
        return new() { ["hostAdmin"] = flags.Contains("host-admin"), ["windowsGuests"] = flags.Contains("windows-guests"), ["usage"] = flags.Contains("usage"), ["children"] = flags.Contains("children"), ["media"] = flags.Contains("media"), ["console"] = flags.Contains("console"), ["updates"] = flags.Contains("updates"), ["network"] = flags.Contains("network"), ["networkMode"] = flags.Contains("network-mode"), ["primaryCpu"] = flags.Contains("primary-cpu"), ["primaryMemory"] = flags.Contains("primary-memory"), ["primaryNested"] = flags.Contains("primary-nested") };
    }
