...
public static class Program
{
    ...
    {
        if (args.Length != 1 || args[0] != "--fake") { Console.Error.WriteLine("Use --fake for the portable test host. The desktop app supplies Windows adapters."); return 2; }
        await using var app = IpcServer.Build(services => services.AddCompanionFakes().AddCompanionHost());
