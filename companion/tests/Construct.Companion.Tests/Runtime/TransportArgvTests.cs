...
public sealed class TransportArgvTests
{
    ...
    public async Task ConcreteTransportPinsScriptWatchAndTunnelArgv()
    {
        ...
        await using var tunnel = ssh.SpawnTunnel(new(19000, 80, "0.0.0.0", "203.0.113.2", 8080));
        Assert.Contains("0.0.0.0:19000:203.0.113.2:8080", runner.Invocations[2].Arguments);
