...
public sealed class ForwarderRuntimeTests
{
    ...
    public async Task RemoteChildListsAndAcksUseUserCredentialAndChildRoute()
    {
        ...
        api.Responses.Enqueue(new(200, JsonDocument.Parse("""[{"id":"child-web","vmPort":80,"destination":{"vmName":"child","via":"primary","connectAddress":"203.0.113.2","connectPort":8080}}]""").RootElement));
