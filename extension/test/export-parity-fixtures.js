...
function hostLabel() {
  ...
  const valid = ["::", "::1", "fe80::1", "2001:db8::8a2e:370:7334", "1:2:3:4:5:6:7:8", "0:0:0:0:0:0:0:0", "1::", "::2", "0::0", "::ffff:203.0.113.1", "1:2:3:4:5:6:1.2.3.4", "::1.2.3.4", "1::1.2.3.4", "1:2:3:4:5:6:7::", "fe80::0204:61ff:fe9d:f156", "ABCD::1"];
...
function lifecycleInvocations() {
  ...
  const settings={gitName:"-someone 'ü'",gitEmail:"a@b",ram:"12",disk:"100",cpu:"6",ubuntu:"24.04",serveWeb:true,tunnel:false,smb:false,partialStreaming:true,mic:false,opencodeBackgroundWatcher:true,t3code:true,t3codeChannel:"nightly",t3codeLimitResume:false,autoCheckpoints:false,historyRetentionDays:"14"};
...
async function updatesPlanning() {
 ...
 for(const markers of [{ref:"main",installedCommit:"abcdef1234567890",provisionedCommit:"abcdef1234567890"},{ref:"main",installedCommit:"def56789",provisionedCommit:"abc12345"},{ref:"topic",installedCommit:"def56789",provisionedCommit:""}])for(const guest of [null,"7654321",""])rows.push({kind:"vmConstruct",markers,guest,output:m.vmConstruct(markers,guest)});
...
function forwardRuntime() {
  ...
  const dest = {vmName:"child",via:"primary",connectAddress:"203.0.113.2",connectPort:8080,verified:false};
