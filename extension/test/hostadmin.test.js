...
(async () => {
  console.log("\n=== feature detection ===");
  deep("features: every flag false without apiFeatures", ha.featureSet({}), { hostAdmin: false, children: false, media: false, console: false, updates: false, network: false, networkMode: false, primaryCpu: false, primaryMemory: false });
  deep("features: the full list", ha.featureSet(HEALTH_FULL), { hostAdmin: true, children: true, media: true, console: true, updates: true, network: true, networkMode: false, primaryCpu: true, primaryMemory: true });
  deep("features: stage-1 service advertises host-admin only", ha.featureSet({ apiFeatures: ["host-admin"] }), { hostAdmin: true, children: false, media: false, console: false, updates: false, network: false, networkMode: false, primaryCpu: false, primaryMemory: false });
