...
(async () => {
  console.log("\n=== feature detection ===");
  deep("features: every flag false without apiFeatures", ha.featureSet({}), { hostAdmin: false, usage: false, windowsGuests: false, children: false, media: false, console: false, updates: false, network: false, networkMode: false, primaryCpu: false, primaryMemory: false, primaryNested: false });
  deep("features: the full list", ha.featureSet(HEALTH_FULL), { hostAdmin: true, usage: true, windowsGuests: false, children: true, media: true, console: true, updates: true, network: true, networkMode: false, primaryCpu: true, primaryMemory: true, primaryNested: false });
  deep("features: stage-1 service advertises host-admin only", ha.featureSet({ apiFeatures: ["host-admin"] }), { hostAdmin: true, usage: false, windowsGuests: false, children: false, media: false, console: false, updates: false, network: false, networkMode: false, primaryCpu: false, primaryMemory: false, primaryNested: false });
