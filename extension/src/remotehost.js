...
function createClient(opts = {}) {
  ...
  return {
    ...
    vmDefaults: () => request("GET", "/vm-defaults"),
    vmMemory: (name) => request("GET", `/vms/${encodeURIComponent(name)}/memory`),
    vmNetwork: (name) => request("GET", `/vms/${encodeURIComponent(name)}/network`),
    setVmNetwork: (name, body) => request("PUT", `/vms/${encodeURIComponent(name)}/network`, body),
    vmNested: (name) => request("GET", `/vms/${encodeURIComponent(name)}/nested`),
    setVmNested: (name, body) => request("PUT", `/vms/${encodeURIComponent(name)}/nested`, body),
    setVmMemory: (name, body) => request("PUT", `/vms/${encodeURIComponent(name)}/memory`, body),
    vmIdlePolicy: (name) => request("GET", `/vms/${encodeURIComponent(name)}/idle-policy`),
    setVmIdlePolicy: (name, body) => request("PUT", `/vms/${encodeURIComponent(name)}/idle-policy`, body),
    vmCpu: (name) => request("GET", `/vms/${encodeURIComponent(name)}/cpu`),
    setVmCpu: (name, body) => request("PUT", `/vms/${encodeURIComponent(name)}/cpu`, body),
