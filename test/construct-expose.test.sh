...
printf '{"kind":"direct","vmPort":3000,"target":"host","publicPort":null,"url":"http://10.0.3.50:3000/"}' >"${stub_dir}/response"
remote_out="$(remote 3000 --to host 2>&1)"; remote_code=$?
ok "direct: prints the VM address and exits successfully" test "${remote_code}:${remote_out}" = "0:http://10.0.3.50:3000/"
