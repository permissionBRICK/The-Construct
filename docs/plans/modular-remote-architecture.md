...
| in flight | Phase 2 review round 8 (also covers the B8x seams); B9 docs pass on `docs/b9` (incl. `docs/field-test-remote-host.md` checklist). Remaining: field test on the home domain. |
