...
**Finding (field test 2026-09-02, `pc-1`, WSL 2.6.3):** `wsl.exe` run as LocalSystem
...
the `<service root>\wsl` import) is therefore unusable. Decision (the project owner): run `constructd`
