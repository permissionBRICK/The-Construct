...
public sealed class PersistenceFoundationTests : IDisposable
{
    ...
    private static Vm Child(string name = "child") => Primary(name) with { Kind = VmKind.Child, Parent = "parent", VmTokenHash = null, RamMb = 512,
        Incarnation = null, Hardware = new(1,512,10,2,false,null,false,[],true), Lease = new("1h",3600,null,null,LeaseState.Inactive,0,null,null) };
