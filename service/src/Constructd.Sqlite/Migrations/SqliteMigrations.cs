...
public static class SqliteMigrations
{
    ...
    public static IReadOnlyList<ISqliteMigration> All { get; } = [new M100_VmKindsAndDelegation(), new M200_MediaRegistry(), new M300_CapacityLedger(), new M400_JobOperationKeys()];
