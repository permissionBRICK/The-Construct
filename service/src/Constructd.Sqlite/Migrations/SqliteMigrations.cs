...
public static class SqliteMigrations
{
    ...
    public static IReadOnlyList<ISqliteMigration> All { get; } = [new M100_VmKindsAndDelegation(), new M200_MediaRegistry(), new M300_CapacityLedger(), new M400_JobOperationKeys(), new M600_HostUpdates(), new M700_NetworkPolicy(), new M800_SourceCache()];
