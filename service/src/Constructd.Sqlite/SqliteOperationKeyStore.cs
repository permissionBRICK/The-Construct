...
public sealed class SqliteOperationKeyStore(SqliteDatabase database) : IOperationKeyStore
{
    ...
    public static bool CompleteInTransaction(SqliteConnection connection, SqliteTransaction transaction, string owner, string kind, string key, string responseJson)
    {
