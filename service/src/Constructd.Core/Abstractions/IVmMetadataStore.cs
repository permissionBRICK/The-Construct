...
{
    /// <summary>Record a confirmed pressure save under the VM gate, fenced by its power generation.</summary>
    Task<bool> RecordPressureSaveAsync(string name, long expectedGeneration, DateTimeOffset at, CancellationToken ct);
