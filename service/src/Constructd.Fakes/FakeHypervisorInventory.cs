...
{
    public InventorySnapshot Snapshot { get; set; } = new(1, DateTimeOffset.MinValue, new(8, 16L << 30, 12L << 30, [new("fake:", 100L << 30, 80L << 30)], DateTimeOffset.MinValue, UsedRamBytes: 4L << 30), [], true, []);
